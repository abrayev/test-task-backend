# Задача (Backend Senior/Teamlead): Вам необходимо разработать бэкенд системы управления обучением на языке программирования Golang. #
...
-	Ссылка на ваш репозиторий с кодом (отправлять [Named Link](https://t.me/cottissimo "сюда"));
-	Образы Docker;
